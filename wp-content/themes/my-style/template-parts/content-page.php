 ...
 */
?>
<article <?php echo wp_kses_post(my_style__animation( "my_style__articles_animation" )); ?> style="width: 100%;" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
<?php if ( has_post_thumbnail() and get_theme_mod('hide_featured') and is_singular() ) { ?>
	...
	<div class="entry-content">
		...
		the_content();
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'my-style' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
